...
const StyledMethodSelect = styled(Select)({
    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent>
        ...
        <input
          ...
          accept=".json"
        />
        <Typography variant="body1" style={{ marginTop: theme.spacing(2), marginBottom: theme.spacing(1) }}>
          或粘贴 JSON 内容:
        </Typography>
        <TextField
          multiline
    ...
    <Dialog open={open} onClose={onClose} maxWidth="lg" fullWidth>
          ...
          <Box style={{ flexGrow: 1, overflow: 'auto' }}>
            ...
            <TabPanel value={tabValue} index={1}>
              <ParameterTable
                ...
                setSnackbar={setSnackbar}
              />
              <Typography variant="h6" style={{ marginTop: theme.spacing(2) }} color="secondary">Request Example</Typography>
              <StyledJsonEditor
                multiline
                rows={10}
                variant="outlined"
            ...
            <TabPanel value={tabValue} index={2}>
              <ParameterTable
                ...
                setSnackbar={setSnackbar}
              />
              <Typography variant="h6" style={{ marginTop: theme.spacing(2) }} color="secondary">Response Example</Typography>
              <StyledJsonEditor
                multiline
                rows={10}
                variant="outlined"
            ...
            <TabPanel value={tabValue} index={3}>
              <ParameterTable
                ...
                setSnackbar={setSnackbar}
              />
              <Typography variant="h6" style={{ marginTop: theme.spacing(2) }} color="secondary">Code Error Example</Typography>
              <StyledJsonEditor
                multiline
                rows={10}
                variant="outlined"
      ...
      <DialogActions>
        <Button variant="outlined" color="secondary" onClick={handleReset}>
          <RestartAltIcon style={{ marginRight: theme.spacing(1) }} />
          重置
        </Button>
        <Button variant="contained" color="primary" onClick={handleImportClick}>
          <UploadIcon style={{ marginRight: theme.spacing(1) }} />
          导入 Swagger
        </Button>
...
export default function ApiCatalog() {
  ...
  return (
    <ThemeProvider theme={theme}>
      <CssBaseline />
      <Box style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <Container style={{ marginTop: theme.spacing(4), marginBottom: theme.spacing(4), flexGrow: 1 }}>
              ...
              <Grid item xs={12} sm={6} md={4} key={category.name}>
                <Card>
                  <CardContent>
                    ...
                    <Typography style={{ marginBottom: theme.spacing(1.5) }} color="textSecondary">
